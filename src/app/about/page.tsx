...
export  default function AboutPage() {
  ...
  const interests = (
    about.interests as unknown as { zh: string[]; en: string[] }
  )[lang];
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start pt-8">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center text-center md:sticky md:top-24">
            ...
            <p className="text-primary-600 dark:text-primary-400 font-semibold text-lg mb-4">
              {lang === "zh"
                ? site.profile.occupation_zh
                : site.profile.occupation}
            </p>
          ...
          <div className="md:w-2/3 flex flex-col justify-center">
            <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 leading-relaxed">
              ...
              <blockquote className="not-italic border-l-4 border-primary-500 pl-6 py-2 mb-10 bg-gray-50 dark:bg-gray-800/50 rounded-r-xl">
                <p className="text-xl font-serif italic text-gray-800 dark:text-gray-200 m-0">
                  "{motto}"
                </p>
              </blockquote>
              ...
              {bio.split("\n\n").map((block, index) => {
                const processInline = (text: string) => {
                  return text
                    ...
                    .replace(
                      /\[(.*?)\]\((.*?)\)/g,
                      '<a href="$2" target="_blank" rel="noopener noreferrer" class="font-medium text-primary-600 hover:text-primary-500 underline decoration-primary-500/30 hover:decoration-primary-500 underline-offset-4 transition-all">$1</a>',
                    );
                };
      ...
      <div className="py-16">
        ...
        <div className="relative border-l border-gray-200 dark:border-gray-800 ml-5 space-y-12">
          {about.experiences.map((exp, idx) => (
            ...
            >
              <div
                className={`absolute -left-[5px] top-2 w-2.5 h-2.5 rounded-full ring-4 ring-white dark:ring-gray-950 ${exp.current ? "bg-green-500" : "bg-gray-300 dark:bg-gray-600"}`}
              />
