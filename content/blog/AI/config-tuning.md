...
![企微实际对话：AI 读取桌面文件列表](/images/blog/config-tuning/wecom-demo-desktop-files.jpg)

**场景二：定时任务——让 AI 自己"上班"**

OpenClaw 支持三种定时任务：一次性提醒（"20 分钟后提醒我喝水"）、周期性任务（"每天早上 8 点播报天气"）、Cron 表达式（"每周一上午 9 点"）。

![企微实际对话：AI 介绍定时任务类型](/images/blog/config-tuning/wecom-demo-scheduled-tasks.jpg)
...
![企微实际对话：AI 分析发送的图片内容](/images/blog/config-tuning/wecom-demo-image-recognition.jpg)
